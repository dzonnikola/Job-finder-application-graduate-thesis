<?php
	...
	$queryKategorija = "SELECT nazivKategorije FROM kategorije WHERE idKategorije='$katId' LIMIT 1";
...
<html lang="sr">
	<head>
		...
		<title><?php echo $row['nazivKategorije'];?> | IT berza - portal za pretragu poslova u IT struci</title>
	</head>
	<?php
		        ...
		        <div class="row justify-content-md-center">
		          <div class="col-md-10">
		            <div class="text-center">
		              ...
		              <h1 style="color:black;"><?php echo $row['nazivKategorije'];?> </h1>
		              <hr class="lines w-50"><br>
		              <?php
		              }
		              ?>
		              <h6 style="color:black;" ><b>Trenutni oglasi u ponudi u ovoj kategoriji:</b></h6>
		            </div>
		          </div>
		        </div>
